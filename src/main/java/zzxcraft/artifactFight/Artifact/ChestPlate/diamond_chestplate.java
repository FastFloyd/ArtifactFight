...
public class diamond_chestplate extends ArtifactChestPlateFather {
    public diamond_chestplate(Player player) {
        super(player);
        this.setItemStack(ItemStack.of(Material.DIAMOND_CHESTPLATE));
    }
    @Override
