...
public class leather_chestplate extends ArtifactChestPlateFather {
    public leather_chestplate(Player player) {
        super(player);
        this.setItemStack(ItemStack.of(Material.LEATHER_CHESTPLATE));
    }
