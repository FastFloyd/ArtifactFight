...
public class speed_chestplate_plus_plus extends ArtifactChestPlateFather {
    public speed_chestplate_plus_plus(Player player) {
        ...
        itemMeta.addAttributeModifier(Attribute.MOVEMENT_SPEED,new AttributeModifier(new NamespacedKey(ArtifactFight.getMainClass(), UUID.randomUUID().toString()),0.075, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST));
