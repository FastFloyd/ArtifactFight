...
public class power_bow_plus extends ArtifactBowFather {
    ...
    public void onHit(ProjectileHitEvent event) {
        ((Player)event.getHitEntity()).damage(7.0, DamageSource.builder(DamageType.ARROW).withCausingEntity(this.getPlayer()).withDamageLocation(event.getEntity().getLocation()).build());
    }
