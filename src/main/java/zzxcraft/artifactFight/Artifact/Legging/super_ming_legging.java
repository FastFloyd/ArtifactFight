...
public class super_ming_legging extends ArtifactLeggingFather {
    public super_ming_legging(Player player) {
        super(player);
        ...
        itemMeta.addAttributeModifier(Attribute.MAX_HEALTH, new AttributeModifier(new NamespacedKey(ArtifactFight.getMainClass(), UUID.randomUUID().toString()),2, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS));
