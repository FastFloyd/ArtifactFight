...
public class dragon_helmet extends ArtifactHelmetFather {
    public dragon_helmet(Player player) {
        super(player);
        ItemStack itemStack=ItemStack.of(Material.DIAMOND_HELMET);
        ItemMeta itemMeta=itemStack.getItemMeta();
        itemMeta.displayName(Component.text("龙之头盔"));
        ...
        itemMeta.addAttributeModifier(Attribute.ARMOR_TOUGHNESS,new AttributeModifier(new NamespacedKey(ArtifactFight.getMainClass(),UUID.randomUUID().toString()),2, AttributeModifier.Operation.ADD_NUMBER,EquipmentSlotGroup.HEAD));
