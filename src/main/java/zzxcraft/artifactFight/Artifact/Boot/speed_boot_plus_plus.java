...
public class speed_boot_plus_plus extends ArtifactBootFather {
    public speed_boot_plus_plus(Player player) {
        ...
        itemMeta.addAttributeModifier(Attribute.MOVEMENT_SPEED,new AttributeModifier(new NamespacedKey(ArtifactFight.getMainClass(), UUID.randomUUID().toString()),0.015, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET));
