...
public class speed_sword extends ArtifactMainWeaponFather {
    public speed_sword(Player player, Integer slot) {
        super(player, slot);
        ItemStack itemStack=ItemStack.of(Material.WOODEN_SWORD);
        ItemMeta itemMeta=itemStack.getItemMeta();
        itemMeta.displayName(Component.text("轻盈之剑"));
        itemMeta.lore(List.of(Component.text("轻盈 I", TextColor.color(168,168,168))));
        ...
        itemMeta.addAttributeModifier(Attribute.ATTACK_SPEED,new AttributeModifier(new NamespacedKey(ArtifactFight.getMainClass(), UUID.randomUUID().toString()),-1.1, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND));
