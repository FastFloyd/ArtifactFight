...
public class speed_sword_plus extends ArtifactMainWeaponFather {
    public speed_sword_plus(Player player, Integer slot) {
        super(player, slot);
        ItemStack itemStack=ItemStack.of(Material.WOODEN_SWORD);
        ItemMeta itemMeta=itemStack.getItemMeta();
        itemMeta.displayName(Component.text("加强轻盈之剑"));
        itemMeta.lore(List.of(Component.text("轻盈 II", TextColor.color(168,168,168))));
